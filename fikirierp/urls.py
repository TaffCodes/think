...
from equipment.api_views import (
    EquipmentItemViewSet, EquipmentRequestViewSet, RepairLogViewSet
)
...
router.register(r'equipment/repair-log', RepairLogViewSet, basename='repair-log')
